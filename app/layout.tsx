  ...
  return (
    <html lang="en">
      <body className={`${inter.className} min-h-screen bg-gray-50 flex flex-col`}>
        <header className="text-white p-4 shadow-md" style={{ backgroundColor: "rgb(7 17 26 / 80%)" }}>
        ...
        <main className="container mx-auto py-8 px-4 flex-grow mb-2">{children}</main>

        <footer className="p-4" style={{ backgroundColor: "rgb(7 17 26 / 80%)" }}>
          <div className="container mx-auto text-center text-gray-100 text-sm">
