...
import { grade4MathData, type Question } from "@/data/grade4/mathData"
import Link from "next/link"
import { ArrowLeft, CheckCircle } from "lucide-react"

const Grade4Math: React.FC = () => {
  const quizData = grade4MathData
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedName = localStorage.getItem("math4StudentName")
      const savedAnswers = localStorage.getItem("math4Answers")
      const savedStep = localStorage.getItem("math4CurrentStep")
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && studentName) {
      localStorage.setItem("math4StudentName", studentName)
      localStorage.setItem("math4Date", date)
      localStorage.setItem("math4Answers", JSON.stringify(answers))
      localStorage.setItem("math4CurrentStep", String(currentStep))
    }
  ...
  useEffect(() => {
    if (submitted && typeof window !== "undefined") {
      localStorage.removeItem("math4StudentName")
      localStorage.removeItem("math4Date")
      localStorage.removeItem("math4Answers")
      localStorage.removeItem("math4CurrentStep")
    }
  }, [submitted])
