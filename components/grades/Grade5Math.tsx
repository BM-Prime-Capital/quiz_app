...
const Grade5Math: React.FC = () => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedName = localStorage.getItem("math5StudentName")
      const savedAnswers = localStorage.getItem("math5Answers")
      const savedStep = localStorage.getItem("math5CurrentStep")
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && studentName) {
      localStorage.setItem("math5StudentName", studentName)
      localStorage.setItem("math5Date", date)
      localStorage.setItem("math5Answers", JSON.stringify(answers))
      localStorage.setItem("math5CurrentStep", String(currentStep))
    }
  ...
  useEffect(() => {
    if (submitted && typeof window !== "undefined") {
      localStorage.removeItem("math5StudentName")
      localStorage.removeItem("math5Date")
      localStorage.removeItem("math5Answers")
      localStorage.removeItem("math5CurrentStep")
    }
  }, [submitted])
