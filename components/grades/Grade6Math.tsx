...
const Grade6Math: React.FC = () => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedName = localStorage.getItem("math6StudentName")
      const savedAnswers = localStorage.getItem("math6Answers")
      const savedStep = localStorage.getItem("math6CurrentStep")
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && studentName) {
      localStorage.setItem("math6StudentName", studentName)
      localStorage.setItem("math6Date", date)
      localStorage.setItem("math6Answers", JSON.stringify(answers))
      localStorage.setItem("math6CurrentStep", String(currentStep))
    }
  ...
  useEffect(() => {
    if (submitted && typeof window !== "undefined") {
      localStorage.removeItem("math6StudentName")
      localStorage.removeItem("math6Date")
      localStorage.removeItem("math6Answers")
      localStorage.removeItem("math6CurrentStep")
    }
  }, [submitted])
